...
public class DatabaseBadgeDescriptor extends BadgeDescriptor {
    private int id = -1;
    ...
    DatabaseBadgeDescriptor(DatabaseBadgeManager databaseBadgeManager) {
        this.databaseBadgeManager = databaseBadgeManager;
    }

    DatabaseBadgeDescriptor(DatabaseBadgeManager databaseBadgeManager, int id, String shortName, String name, String description, int maxLevel, String levelNames) {
